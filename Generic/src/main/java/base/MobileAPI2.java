...
public class MobileAPI2 {
    ...
    public static AppiumDriver getDriver(String OS, String deviceName, String version) throws IOException {
        ...
        if (OS.equalsIgnoreCase("Android")) {
            ...
            capabilities.setCapability(MobileCapabilityType.APP, "/Users/mdhasan/Documents/untitled folder/2/BootCampLab2019/MobileAutomationWalmart/src/app/Walmart_new.apk");
            capabilities.setCapability(MobileCapabilityType.APP_PACKAGE, "com.walmart.android");
            capabilities.setCapability(MobileCapabilityType.APP_ACTIVITY, "com.walmart.android.app.main.MainActivity");
            ...
            cap.setCapability(MobileCapabilityType.APP_PACKAGE, "com.walmart.android");
            cap.setCapability(MobileCapabilityType.APP_ACTIVITY, "com.walmart.android.app.main.MainActivity");
